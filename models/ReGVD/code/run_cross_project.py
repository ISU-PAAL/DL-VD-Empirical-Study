...
BASE_DIR = '<ANONYMOUS>/<ANONYMOUS>/data/RQ.B4.1/'
SAVED_DIR = '<ANONYMOUS>/<ANONYMOUS>/saved_models/regvd/RQB4.1/'
if __name__ == "__main__":
    ...
    arg.test_data_file = os.path.join(dataset_dir, '{}.jsonl'.format(ar.fold))
