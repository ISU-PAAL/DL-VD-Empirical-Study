...
if mydataset =='devign':
    ...
    file_loc = 'data/finetune/combined/' + args.data_folder + '/test.jsonl'
    print(file_loc)
...
try:
    model_foldername = 'VB-CNN_%s'%(mydataset) + args.model_folder
...
## Testing
print('models/' + model_foldername + '_' + str(args.seed_input) + '/model_ep_10.tar')
for i in range(1,21):
    checkpoint = torch.load('models/' + args.model_folder + '/model_ep_' + str(i) + '.tar', map_location='cuda')
