...
fold=$1
seed=$2
savedir=models/devign/ggnn/v$fold/$seed
...
exec python -u Vuld_SySe/representation_learning/api_test.py --input_dir data/devign/full_experiment_real_data_processed --fold $fold --seed $seed --features ggnn --train 2>&1 | tee "$(basename $0)_reveal_${fold}_${seed}.log"
