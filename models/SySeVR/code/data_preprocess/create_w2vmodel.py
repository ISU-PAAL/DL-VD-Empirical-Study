...
def main():
    dec_tokenFlaw_path = ['<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/corpus/']
    w2v_model_path = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/w2v_model/wordmodel3" 
