...
if __name__ == "__main__":
    ...
    VECTORPATH = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/vector/"
    W2VPATH = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/w2v_model/wordmodel3"
    ...
    dlTrainCorpusPath = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/dl_input/train/"
    dlTestCorpusPath = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/dl_input/test/"
    get_dldata(VECTORPATH, dlTrainCorpusPath, dlTestCorpusPath)
    
    print("get dl input success!")
