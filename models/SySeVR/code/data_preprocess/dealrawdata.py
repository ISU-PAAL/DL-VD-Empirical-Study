...
if __name__ == "__main__":
    ...
    traindataSetPath = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/dl_input_shuffle/train/"
    testdataSetPath = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/dl_input_shuffle/test/"
