...
slice_prefix = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/slice_files/"
syvcs_prefix = "<ANONYMOUS>/<ANONYMOUS>/sysevr/data/SARD/syvcs/"
...
def api_slice():
    count = 1
    store_filepath = slice_prefix + "api_slices.txt"
    f = open(syvcs_prefix + "sensifunc_slice_points.pkl", 'rb')
...
def pointers_slice():
    count = 1
    store_filepath = slice_prefix + "pointersuse_slices.txt"
    f = open(syvcs_prefix + "pointuse_slice_points.pkl", 'rb')
...
def arrays_slice():
    count = 1
    store_filepath = slice_prefix + "arraysuse_slices.txt"
    f = open(syvcs_prefix + "arrayuse_slice_points.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    f.close()
...
def integeroverflow_slice():
    count = 1
    store_filepath = slice_prefix + "integeroverflow_slices.txt"
    f = open(syvcs_prefix + "integeroverflow_slice_points_new.pkl", 'rb')
