...
def dealfunc_nvd(folder_path,diff_path):
    ...
    with open('<ANONYMOUS>/<ANONYMOUS>/sysevr/data/NVD/vul_lines/vul_context_func.pkl','wb') as f:
...
if __name__ == "__main__":
    ...
    data_source1 = '<ANONYMOUS>/<ANONYMOUS>/sysevr/data/NVD/NVD_data/NVD/'
    diff_path = '<ANONYMOUS>/<ANONYMOUS>/sysevr/data/NVD/NVD_diff/'
    dealfunc_nvd(data_source1,diff_path)
    
    # data_source2 = '<ANONYMOUS>/<ANONYMOUS>/sysevr/data/NVD/source_code/'
