...
class GNNExplainer(nn.Module):
    ...
    def explain_graph(self, batch, **kwargs):
        ...
        graph, feat, edge_types = batch.get_network_inputs(cuda=True, device="cuda:0")
        ...
        for _ in range(self.num_epochs):
            ...
            logits = self.model(batch, feat=h, eweight=edge_mask.sigmoid(), **kwargs)
            logits = get_softmax(logits)
