// commit message FFmpeg@0f34c0789f (target=1, prob=0.96699166, correct=True): avcodec/pictordec: runtime error: left shift of 15 by 28 places cannot be represented in type 'int'
/*0  */ static void picmemset(PicContext *s, AVFrame *frame, unsigned value, int run,  // (10) 0.04297
/*2  */                       int *x, int *y, int *plane, int bits_per_plane)          // (0) 0.07812
/*4  */ {                                                                              // (22) 0.001953
/*6  */     uint8_t *d;                                                                // (20) 0.01953
/*8  */     int shift = *plane * bits_per_plane;                                       // (17) 0.0293
/*10 */     unsigned mask  = ((1 << bits_per_plane) - 1) << shift;                     // (11) 0.04297
