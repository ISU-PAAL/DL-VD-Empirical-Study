// commit message FFmpeg@c23acbaed4 (target=1, prob=0.9656749, correct=True): Don't use ff_cropTbl[] for IDCT.
/*0  */ static void vc1_inv_trans_8x4_dc_c(uint8_t *dest, int linesize, DCTELEM *block)  // (0) 0.1135
/*2  */ {                                                                                // (18) 0.003067
/*4  */     int i;                                                                       // (16) 0.0184
/*6  */     int dc = block[0];                                                           // (15) 0.03067
/*8  */     const uint8_t *cm;                                                           // (14) 0.03374
/*10 */     dc = ( 3 * dc +  1) >> 1;                                                    // (10) 0.04908
/*12 */     dc = (17 * dc + 64) >> 7;                                                    // (12) 0.04601
/*14 */     cm = ff_cropTbl + MAX_NEG_CROP + dc;                                         // (1) 0.06442
/*16 */     for(i = 0; i < 4; i++){                                                      // (11) 0.04908
