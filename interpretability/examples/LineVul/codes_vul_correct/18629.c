// commit message qemu@7453c96b78 (target=1, prob=0.5832542, correct=True): qcow2: Helper function for refcount modification
...
/*4   */                                uint16_t **refcount_table, int64_t *nb_clusters)  // (0) 0.09766
/*6   */ {                                                                                // (24) 0.001953
/*8   */     BDRVQcowState *s = bs->opaque;                                               // (8) 0.03516
...
/*106 */         return ret;                                                              // 0.0
/*108 */     }                                                                            // 0.0
/*112 */     return check_refblocks(bs, res, fix, rebuild, refcount_table, nb_clusters);  // 0.0
/*114 */ }                                                                                // 0.0
