// commit message FFmpeg@afa982fdae (target=1, prob=0.44902217, correct=False): corrected mpeg audio encoding overflows - now it should give correct quality even for very high volumes
/*0   */ static void compute_scale_factors(unsigned char scale_code[SBLIMIT],         // (11) 0.03907
/*2   */                                   unsigned char scale_factors[SBLIMIT][3],   // (1) 0.09374
...
/*210 */                                                                              // 0.0
/*212 */ #if 0                                                                        // 0.0
/*214 */         printf("%d: %2d %2d %2d %d %d -> %d\n", j,                           // 0.0
/*216 */                sf[0], sf[1], sf[2], d1, d2, code);                           // 0.0
/*218 */ #endif                                                                       // 0.0
/*220 */         scale_code[j] = code;                                                // 0.0
/*222 */         sf += 3;                                                             // 0.0
/*224 */     }                                                                        // 0.0
/*226 */ }                                                                            // 0.0
