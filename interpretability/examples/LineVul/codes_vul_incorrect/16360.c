// commit message qemu@9ecaa27e71 (target=1, prob=0.2928203, correct=False): target/openrisc: Streamline arithmetic and OVE
/*0   */ static void dec_calc(DisasContext *dc, uint32_t insn)                        // (7) 0.03906
/*2   */ {                                                                            // (21) 0.001953
/*4   */     uint32_t op0, op1, op2;                                                  // (9) 0.03125
/*6   */     uint32_t ra, rb, rd;                                                     // (15) 0.0293
/*8   */     op0 = extract32(insn, 0, 4);                                             // (10) 0.03125
/*10  */     op1 = extract32(insn, 8, 2);                                             // (11) 0.03125
/*12  */     op2 = extract32(insn, 6, 2);                                             // (12) 0.03125
/*14  */     ra = extract32(insn, 16, 5);                                             // (16) 0.0293
/*16  */     rb = extract32(insn, 11, 5);                                             // (13) 0.03125
/*18  */     rd = extract32(insn, 21, 5);                                             // (14) 0.03125
/*22  */     switch (op0) {                                                           // (19) 0.01758
/*24  */     case 0x0000:                                                             // (20) 0.01562
/*26  */         switch (op1) {                                                       // (17) 0.02539
/*28  */         case 0x00:    /* l.add */                                            // (8) 0.03906
/*30  */             LOG_DIS("l.add r%d, r%d, r%d\n", rd, ra, rb);                    // (0) 0.07812
/*32  */             {                                                                // (18) 0.02344
/*34  */                 TCGLabel *lab = gen_new_label();                             // (6) 0.05273
/*36  */                 TCGv_i64 ta = tcg_temp_new_i64();                            // (5) 0.06445
/*38  */                 TCGv_i64 tb = tcg_temp_new_i64();                            // (4) 0.06641
/*40  */                 TCGv_i64 td = tcg_temp_local_new_i64();                      // (2) 0.06836
/*42  */                 TCGv_i32 res = tcg_temp_local_new_i32();                     // (3) 0.06836
/*44  */                 TCGv_i32 sr_ove = tcg_temp_local_new_i32();                  // (1) 0.07227
/*46  */                 tcg_gen_extu_i32_i64(ta, cpu_R[ra]);                         // 0.0
/*48  */                 tcg_gen_extu_i32_i64(tb, cpu_R[rb]);                         // 0.0
/*50  */                 tcg_gen_add_i64(td, ta, tb);                                 // 0.0
/*52  */                 tcg_gen_extrl_i64_i32(res, td);                              // 0.0
...
/*110 */             {                                                                // 0.0
/*112 */                 TCGLabel *lab = gen_new_label();                             // 0.0
...
/*142 */                 tcg_gen_extrl_i64_i32(res, td);                              // 0.0
...
/*204 */             {                                                                // 0.0
/*206 */                 TCGLabel *lab = gen_new_label();                             // 0.0
...
/*226 */                 tcg_gen_extrl_i64_i32(res, td);                              // 0.0
...
/*388 */             {                                                                // 0.0
/*390 */                 TCGLabel *lab0 = gen_new_label();                            // 0.0
/*392 */                 TCGLabel *lab1 = gen_new_label();                            // 0.0
/*394 */                 TCGLabel *lab2 = gen_new_label();                            // 0.0
/*396 */                 TCGLabel *lab3 = gen_new_label();                            // 0.0
...
/*472 */             {                                                                // 0.0
/*474 */                 TCGLabel *lab0 = gen_new_label();                            // 0.0
/*476 */                 TCGLabel *lab1 = gen_new_label();                            // 0.0
/*478 */                 TCGLabel *lab2 = gen_new_label();                            // 0.0
...
/*556 */                 TCGLabel *lab = gen_new_label();                             // 0.0
...
/*624 */             {                                                                // 0.0
/*626 */                 TCGLabel *lab = gen_new_label();                             // 0.0
...
/*674 */             tcg_gen_ctzi_tl(cpu_R[rd], cpu_R[ra], -1);                       // 0.0
/*676 */             tcg_gen_addi_tl(cpu_R[rd], cpu_R[rd], 1);                        // 0.0
/*678 */             break;                                                           // 0.0
/*680 */         case 0x01:    /* l.fl1 */                                            // 0.0
/*682 */             LOG_DIS("l.fl1 r%d, r%d, r%d\n", rd, ra, rb);                    // 0.0
/*684 */             tcg_gen_clzi_tl(cpu_R[rd], cpu_R[ra], TARGET_LONG_BITS);         // 0.0
/*686 */             tcg_gen_subfi_tl(cpu_R[rd], TARGET_LONG_BITS, cpu_R[rd]);        // 0.0
/*688 */             break;                                                           // 0.0
/*692 */         default:                                                             // 0.0
/*694 */             gen_illegal_exception(dc);                                       // 0.0
/*696 */             break;                                                           // 0.0
/*698 */         }                                                                    // 0.0
/*700 */         break;                                                               // 0.0
/*704 */     case 0x0008:                                                             // 0.0
...
/*708 */         case 0x00:                                                           // 0.0
/*710 */             switch (op2) {                                                   // 0.0
/*712 */             case 0x00:    /* l.sll */                                        // 0.0
/*714 */                 LOG_DIS("l.sll r%d, r%d, r%d\n", rd, ra, rb);                // 0.0
/*716 */                 tcg_gen_shl_tl(cpu_R[rd], cpu_R[ra], cpu_R[rb]);             // 0.0
/*718 */                 break;                                                       // 0.0
/*720 */             case 0x01:    /* l.srl */                                        // 0.0
/*722 */                 LOG_DIS("l.srl r%d, r%d, r%d\n", rd, ra, rb);                // 0.0
/*724 */                 tcg_gen_shr_tl(cpu_R[rd], cpu_R[ra], cpu_R[rb]);             // 0.0
/*726 */                 break;                                                       // 0.0
/*728 */             case 0x02:    /* l.sra */                                        // 0.0
/*730 */                 LOG_DIS("l.sra r%d, r%d, r%d\n", rd, ra, rb);                // 0.0
/*732 */                 tcg_gen_sar_tl(cpu_R[rd], cpu_R[ra], cpu_R[rb]);             // 0.0
/*734 */                 break;                                                       // 0.0
/*736 */             case 0x03:    /* l.ror */                                        // 0.0
/*738 */                 LOG_DIS("l.ror r%d, r%d, r%d\n", rd, ra, rb);                // 0.0
/*740 */                 tcg_gen_rotr_tl(cpu_R[rd], cpu_R[ra], cpu_R[rb]);            // 0.0
/*742 */                 break;                                                       // 0.0
/*746 */             default:                                                         // 0.0
/*748 */                 gen_illegal_exception(dc);                                   // 0.0
/*750 */                 break;                                                       // 0.0
/*752 */             }                                                                // 0.0
/*754 */             break;                                                           // 0.0
/*758 */         default:                                                             // 0.0
/*760 */             gen_illegal_exception(dc);                                       // 0.0
/*762 */             break;                                                           // 0.0
/*764 */         }                                                                    // 0.0
/*766 */         break;                                                               // 0.0
/*770 */     case 0x000c:                                                             // 0.0
...
/*774 */         case 0x00:                                                           // 0.0
/*776 */             switch (op2) {                                                   // 0.0
/*778 */             case 0x00:    /* l.exths */                                      // 0.0
/*780 */                 LOG_DIS("l.exths r%d, r%d\n", rd, ra);                       // 0.0
/*782 */                 tcg_gen_ext16s_tl(cpu_R[rd], cpu_R[ra]);                     // 0.0
/*784 */                 break;                                                       // 0.0
/*786 */             case 0x01:    /* l.extbs */                                      // 0.0
/*788 */                 LOG_DIS("l.extbs r%d, r%d\n", rd, ra);                       // 0.0
/*790 */                 tcg_gen_ext8s_tl(cpu_R[rd], cpu_R[ra]);                      // 0.0
/*792 */                 break;                                                       // 0.0
/*794 */             case 0x02:    /* l.exthz */                                      // 0.0
/*796 */                 LOG_DIS("l.exthz r%d, r%d\n", rd, ra);                       // 0.0
/*798 */                 tcg_gen_ext16u_tl(cpu_R[rd], cpu_R[ra]);                     // 0.0
/*800 */                 break;                                                       // 0.0
/*802 */             case 0x03:    /* l.extbz */                                      // 0.0
/*804 */                 LOG_DIS("l.extbz r%d, r%d\n", rd, ra);                       // 0.0
/*806 */                 tcg_gen_ext8u_tl(cpu_R[rd], cpu_R[ra]);                      // 0.0
/*808 */                 break;                                                       // 0.0
/*812 */             default:                                                         // 0.0
/*814 */                 gen_illegal_exception(dc);                                   // 0.0
/*816 */                 break;                                                       // 0.0
/*818 */             }                                                                // 0.0
/*820 */             break;                                                           // 0.0
/*824 */         default:                                                             // 0.0
/*826 */             gen_illegal_exception(dc);                                       // 0.0
/*828 */             break;                                                           // 0.0
/*830 */         }                                                                    // 0.0
/*832 */         break;                                                               // 0.0
/*836 */     case 0x000d:                                                             // 0.0
...
/*840 */         case 0x00:                                                           // 0.0
/*842 */             switch (op2) {                                                   // 0.0
/*844 */             case 0x00:    /* l.extws */                                      // 0.0
/*846 */                 LOG_DIS("l.extws r%d, r%d\n", rd, ra);                       // 0.0
/*848 */                 tcg_gen_ext32s_tl(cpu_R[rd], cpu_R[ra]);                     // 0.0
/*850 */                 break;                                                       // 0.0
/*852 */             case 0x01:    /* l.extwz */                                      // 0.0
/*854 */                 LOG_DIS("l.extwz r%d, r%d\n", rd, ra);                       // 0.0
/*856 */                 tcg_gen_ext32u_tl(cpu_R[rd], cpu_R[ra]);                     // 0.0
/*858 */                 break;                                                       // 0.0
/*862 */             default:                                                         // 0.0
/*864 */                 gen_illegal_exception(dc);                                   // 0.0
/*866 */                 break;                                                       // 0.0
/*868 */             }                                                                // 0.0
/*870 */             break;                                                           // 0.0
/*874 */         default:                                                             // 0.0
/*876 */             gen_illegal_exception(dc);                                       // 0.0
/*878 */             break;                                                           // 0.0
/*880 */         }                                                                    // 0.0
/*882 */         break;                                                               // 0.0
/*886 */     default:                                                                 // 0.0
/*888 */         gen_illegal_exception(dc);                                           // 0.0
/*890 */         break;                                                               // 0.0
/*892 */     }                                                                        // 0.0
/*894 */ }                                                                            // 0.0
