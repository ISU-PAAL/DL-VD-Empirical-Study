// commit message FFmpeg@3176217c60 (target=0, prob=0.35227376, correct=True): h264: decouple h264_ps from the h264 decoder
...
/*262 */             } else {                                                                            // 0.0
/*264 */                 if (!h->sps.direct_8x8_inference_flag) {                                        // 0.0
