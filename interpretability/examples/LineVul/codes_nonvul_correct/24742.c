// commit message qemu@185698715d (target=0, prob=0.0057806163, correct=True): softfloat: Rename float*_is_nan() functions to float*_is_quiet_nan()
/*0  */ uint64_t helper_fnmsub (uint64_t arg1, uint64_t arg2, uint64_t arg3)                    // (7) 0.06055
/*2  */ {                                                                                       // (20) 0.001953
...
/*64 */             ft0_128 = float128_sub(ft0_128, ft1_128, &env->fp_status);                  // 0.0
...
/*82 */         farg1.d = float64_sub(farg1.d, farg3.d, &env->fp_status);                       // 0.0
/*84 */ #endif                                                                                  // 0.0
